...
<input type="hidden" name="answer_num" value="<c:out value='${boardVO.answer_num}'/>"/>
<input type="hidden" name="answer_lev" value="<c:out value='${boardVO.answer_lev}'/>"/>
<input type="hidden" name="answer_seq" value="<c:out value='${boardVO.answer_seq}'/>"/>
<legend>답변 글</legend>
<p>
...
<input type="text" id="subject" name="subject" value="[답변]<c:out value='${boardVO.subject}'/>">
</p>
<p>
...
<p>
<label for="attached_file">파일수정</label>
<input type="file" id="subject" name="attached_file">
</p>
<p>
